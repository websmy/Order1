...
namespace Helper
{
    public class XMLHelper
    {
        ...
        public static string PageSize
        {
            get
            {
                string strXmlFile = HttpContext.Current.Server.MapPath("~/config/set.config");
                string PageSize = GetXmlNodeByXpath(strXmlFile, "//conn_configuration//PageSize").InnerText.Trim();
                return PageSize;
            }
            set
            {
                string strXmlFile = HttpContext.Current.Server.MapPath("~/config/set.config");
                CreateOrUpdateXmlNodeByXPath(strXmlFile, "//conn_configuration", "PageSize", value);
            }
        }       
