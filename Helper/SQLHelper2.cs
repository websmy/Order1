...
namespace Helper
{
    ...
    public  class SQLHelper2
    {
        ...
        //    String conn = ConfigurationSettings.AppSettings["SqlConnectionString"].ToString() + page.Server.MapPath("~/" + ConfigurationSettings.AppSettings["AccessDbPath"].ToString());
        //    return conn;
        //}
        ...
        {
            String ConnStr = GetConnectionString.iGetConn1;
